...
`CONFIRMADO`: o head atual é `20260808_0005`. Além das tabelas de planejamento,
a revisão mais recente cria `auth_login_throttles` para a limitação durável da
OC60, sem persistir e-mail ou IP brutos.
