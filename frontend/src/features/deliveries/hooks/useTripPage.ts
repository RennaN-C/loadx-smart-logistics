 ...
 *
 * Cada ação fornece uma viagem completa do backend para substituir o estado.
 * Na alteração de entrega, o adapter faz PATCH da entrega seguido de GET da
 * viagem. Não reconstruímos uma viagem parcial a partir da resposta do PATCH.
 */
