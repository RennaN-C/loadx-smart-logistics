...
|---|---|---|---|
| OC62 — Integração ViaCEP no backend | Rennan | Backend / integração | Nenhuma OC anterior da v1.1.0. |
| OC63 — Validação formal de CPF, CNPJ, CNH e telefone | Rennan | Backend / cadastros | Nenhuma OC anterior da v1.1.0. |
| OC64 — Regra de conflito de caminhões | Rennan | Backend / operação | Nenhuma OC anterior da v1.1.0; alinhar conceitos com OC65. |
| OC65 — Regra de conflito de motoristas | Rennan | Backend / operação | Nenhuma OC anterior da v1.1.0; alinhar conceitos com OC64. |
| OC66 — RBAC granular de carregamento e conferência | Rennan | Backend / autorização | Nenhuma OC anterior da v1.1.0; alinhar permissões com Marcelo e Marlon para OC76 e OC75. |
| OC67 — Serviço de disponibilidade da frota | João | Backend / frota | OC64 e OC65 (Rennan). |
...
| OC70 — ViaCEP no cadastro de clientes | Marlon | Frontend / clientes | OC62 (Rennan). |
| OC71 — Validações e feedback dos documentos | Marlon | Frontend / cadastros | OC63 (Rennan). |
| OC72 — Interface de disponibilidade de caminhões e motoristas | Marlon | Frontend / disponibilidade | OC64 e OC65 (Rennan) e OC67 (João); alinhar o contrato de consulta de motoristas entre os três. |
...
| OC75 — Conferência por QR Code/código de barras | Marlon | Frontend / conferência | OC66 (Rennan) e OC76 (Marcelo). |
| OC76 — Backend da conferência por QR Code/código de barras | Marcelo | Backend / conferência | OC66 (Rennan); alinhar contrato com Marlon para OC75. |
...
| OC78 — Estrutura operacional para comprovante de entrega | Marcelo | Backend / entregas | Nenhuma OC anterior da v1.1.0; alinhar com Rennan o ciclo de entregas existente. |
...
2. Rennan executar OC62, OC63, OC64, OC65 e OC66. Marcelo pode iniciar OC77 e o
...
- **Rennan → João:** OC64/OC65 fornecem as regras para OC67 e, por consequência,
  para OC68/OC69.
- **Rennan → Marlon:** OC62 sustenta OC70; OC63 sustenta OC71; OC64/OC65 sustentam
...
- **Rennan → Marcelo → Marlon:** OC66 orienta OC76; o contrato de OC76 viabiliza
...
- **Marcelo ↔ equipe:** OC77 acompanha os fluxos entregues pelos quatro; OC78
  exige alinhamento com Rennan sobre o ciclo de entregas existente.

`PENDENTE DE DEFINIÇÃO`: Rennan, João e Marlon devem explicitar nas Issues de
...
acentos, como `rennan/oc62-viacep-backend`. Os nomes sugeridos estão nos arquivos
...
- [DEV 1 — Rennan: OC62–OC66](01-renan.md).
