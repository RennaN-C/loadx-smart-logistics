...
`CONFIRMADO`: estas são as ocorrências atribuídas a Marlon para a v1.1.0,
...
## OC73 — Painel de status da frota

- **Objetivo resumido:** Apresentar a situação operacional dos caminhões em um painel de frota.
- **Dependências — RECOMENDAÇÃO:** OC68 (João).
- **Status inicial:** PENDENTE.
- **Branch sugerida — RECOMENDAÇÃO:** `marlon/oc73-status-frota`.

## OC74 — Dashboard operacional

- **Objetivo resumido:** Apresentar os indicadores operacionais acordados para acompanhamento da operação.
- **Dependências — RECOMENDAÇÃO:** OC69 (João).
- **Status inicial:** PENDENTE.
- **Branch sugerida — RECOMENDAÇÃO:** `marlon/oc74-dashboard-operacional`.
